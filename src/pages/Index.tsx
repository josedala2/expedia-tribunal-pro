...
import FormacaoAvaliacao from "./portal/FormacaoAvaliacao";
import RelatoriosPessoais from "./portal/RelatoriosPessoais";
import Declaracoes from "./portal/Declaracoes";
      ...
      <div className="flex">
        ...
        <main className={`flex-1 transition-all duration-300 ${isSidebarOpen ? 'lg:ml-80' : 'ml-0'}`}>
          <div className="container mx-auto p-3 md:p-6">
            ...
            {currentView === "formacao-avaliacao" && <FormacaoAvaliacao onBack={() => handleNavigate("meu-perfil")} />}
            {currentView === "relatorios-pessoais" && <RelatoriosPessoais onBack={() => handleNavigate("meu-perfil")} />}
            {currentView === "declaracoes" && <Declaracoes onBack={() => handleNavigate("meu-perfil")} />}
