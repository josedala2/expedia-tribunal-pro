import { ArrowLeft, Plus, Search, Filter, CheckCircle, Clock, AlertCircle, Eye, Trash2, Edit } from "lucide-react";
...
export const CumprimentoDespachos = ({ onBack, onNavigate }: CumprimentoDespachosProps) => {
  ...
  const despachos = [
    {
      id: "DES-2024-001",
      processo: "PV-2024-001",
      tipo: "Solicitação de Elementos",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Cumprimento de Despachos</h1>
